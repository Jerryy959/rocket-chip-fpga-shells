...
class zcu102mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  ...
  //TODO: -Should DDR4 capacity by 256 or 512? VCU118 used the same chip and had it as 512
  //      -Process for creating these parameters involved creating an empty project for the board
  //        and customizing ip for the mig with the correct component/controller type
  //        *This process seemed to suggest AxiAddressWidth should be 28, but when running make it says it should be 31
  //      -Configured for a 300 MHz input reference clock
